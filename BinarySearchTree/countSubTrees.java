...
import BinarySearchTree.countInRange.Count;
    ...
    public static void countinrange(BSTNode root, int data1,int data2, Count count) {
    	if(root == null){
    		...
    		if((root.left == null && root.right==null))
    			count.val +=1;
    		else if(root.left == null && root.right.data <= data2)
    			count.val +=1;
    		else if(root.right == null && root.left.data >=data1)
    			count.val +=1;
    		else if(root.right.data <= data2 && root.left.data >=data1)
    			count.val +=1;
